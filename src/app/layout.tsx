...
export const metadata: Metadata = {
  ...
  description:
    '烟台策高装饰设计有限公司专注于烟台办公楼装修装饰设计、烟台餐厅装修装饰设计、烟台洗浴装修装饰设计、烟台家装别墅住宅装饰装修设计、烟台酒店装饰装修设计、烟台会所装饰装修设计、烟台娱乐KTV装饰装修设计、烟台办公楼室内设计、烟台餐厅室内设计等专业室内设计服务。我们拥有经验丰富的设计团队，秉承"设计创造价值"的理念，为每一个项目注入独特的艺术灵魂。',
  keywords: [
    '烟台策高装饰设计',
    '烟台装饰设计',
    '烟台室内设计',
...
export default function RootLayout({
  ...
  const organizationSchema = {
    ...
    "description": "烟台策高装饰设计有限公司专注于烟台办公楼装修装饰设计、烟台餐厅装修装饰设计、烟台洗浴装修装饰设计、烟台家装别墅住宅装饰装修设计、烟台酒店装饰装修设计、烟台会所装饰装修设计、烟台娱乐KTV装饰装修设计、烟台办公楼室内设计、烟台餐厅室内设计等专业室内设计服务",
    "address": {
      "@type": "PostalAddress",
      "addressLocality": "烟台",
      "addressRegion": "山东省",
  ...
  const serviceSchema = {
    ...
    "@type": "ItemList",
    "name": "烟台策高装饰设计服务范围",
    "description": "专业提供烟台办公楼装修装饰设计、烟台餐厅装修装饰设计、烟台洗浴装修装饰设计、烟台家装别墅住宅装饰装修设计、烟台酒店装饰装修设计、烟台会所装饰装修设计、烟台娱乐KTV装饰装修设计、烟台办公楼室内设计、烟台餐厅室内设计等服务",
    "itemListElement": [
      {
        "@type": "Service",
        "position": 1,
    ...
    <html lang="zh-CN">
      ...
      <body className={`antialiased`}>
        ...
        <div style={{ display: 'none' }} aria-hidden="true">
          <h1>烟台策高装饰设计 烟台办公楼装修装饰设计 烟台办公楼室内设计 烟台餐厅装修装饰设计 烟台餐厅室内设计 烟台洗浴装修装饰设计 烟台洗浴室内设计 烟台家装别墅住宅装饰装修设计 烟台别墅室内设计 烟台酒店装饰装修设计 烟台酒店室内设计 烟台会所装饰装修设计 烟台会所室内设计 烟台娱乐KTV装饰装修设计 烟台KTV室内设计</h1>
          <h2>烟台办公室装修 烟台写字楼装修 烟台办公楼设计 烟台餐饮空间设计 烟台饭店装修 烟台餐厅设计 烟台洗浴中心设计 烟台桑拿装修 烟台洗浴设计 烟台别墅设计 烟台家装设计 烟台住宅装修 烟台宾馆装修 烟台精品酒店设计 烟台酒店设计 烟台私人会所设计 烟台商务会所设计 烟台会所设计 烟台KTV设计 烟台夜总会设计 烟台娱乐场所装修 烟台商业空间设计 烟台软装搭配 烟台展厅设计</h2>
        </div>
